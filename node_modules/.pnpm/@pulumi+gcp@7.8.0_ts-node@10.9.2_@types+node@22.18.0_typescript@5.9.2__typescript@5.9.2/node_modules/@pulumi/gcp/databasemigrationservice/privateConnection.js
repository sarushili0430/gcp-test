 ...
 *     name: "my-network",
 * });
 * const defaultPrivateConnection = new gcp.databasemigrationservice.PrivateConnection("defaultPrivateConnection", {
 *     displayName: "dbms_pc",
 ...
 *     },
 *     vpcPeeringConfig: {
 *         vpcName: defaultNetwork.then(defaultNetwork => defaultNetwork.id),
 *         subnet: "10.0.0.0/29",
 *     },
 * });
 * ```
...
/** @internal */
PrivateConnection.__pulumiType = 'gcp:databasemigrationservice/privateConnection:PrivateConnection';
